        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form role="form" action="{{route('admin.sale.edit',$transaction)}}" method="post" enctype="multipart/form-data">
                            @method('patch')
                            @csrf
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="merchant_name" id="exampleForName"
                                        placeholder="Enter Merchant Name" value="{{ $sale->merchant_name }}" required>
                                </div>
                                <div class="form-group">
